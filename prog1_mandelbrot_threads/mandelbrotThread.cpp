...
void workerThreadStart(WorkerArgs * const args) {
    ...
    // }
    // // printf("Thread %d: startRow = %d, totalRows = %d,output = %p\n", args->threadId, startRow, totalRows, args->output);
    ...
    mandelbrotStepSerial(args->x0, args->y0, args->x1, args->y1, args->width, args->height, args->numThreads, args->threadId, args->maxIterations, args->output);
